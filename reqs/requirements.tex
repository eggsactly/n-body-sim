...
\section*{n-body-system Requirements}
	\subsection*{Functional Requirements}
		\begin{enumerate}[label=FR-\arabic*]
			...
			\item \label{FR.Calculate} When a system of particles has been parsed the program {\em shall} calculate the position and velocity of every particle for every time step in accordance with Newton's law of universal gravitation.
			...
			\item \label{FR.ViewWindow} When user initiates the program, the program {\em shall} plot the position of each particle on a view window where a multiple of the view window's normal vector summed with the particle vector is orthogonal to the view window.
		\end{enumerate}
